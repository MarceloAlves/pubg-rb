...
require "pubg/telemetry/lookup/damage_causer_lookup"
require "pubg/telemetry/lookup/damage_type_lookup"
require "pubg/telemetry/lookup/item_lookup"
require "pubg/telemetry/lookup/vehicle_lookup"
module PUBG
  class Telemetry
    def initialize(args)
